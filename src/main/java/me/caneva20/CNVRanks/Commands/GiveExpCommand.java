...
public class GiveExpCommand extends CommandBase implements ICommand {
    private String command = "givexp";
    private String permission = "cnv.ranks.command.givexp";
    private String usage = "/rankup givexp <player> <amount>";
    private List<String> alias = new ArrayList<>();
    private boolean onlyPlayers = true;
    private String description = "Gives EXP to a player";
    ...
    public void onCommand(CommandSender sender, String[] args, JavaPlugin javaPlugin) {
        ...
        Lang.sendExpGiven(sender, player.getName(), amount);
        Lang.sendExpReceived(player, sender.getName(), amount);
        CNVRanks.getExpManager().giveExp(player, amount);
    }
}
